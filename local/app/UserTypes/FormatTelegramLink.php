...
// еобходим для построения пользовательских полей в редакторе/выборе

class FormatTelegramLink extends StringFormattedType
{
    public const
        USER_TYPE_ID = 'telegram_string_formatted_link', // произвольно
        RENDER_COMPONENT = 'otus:main.field.stringformatted'; // компонент который обрабатывает ссылку на телеграм
        // визуальный вид полей в поле редактирования сущности
